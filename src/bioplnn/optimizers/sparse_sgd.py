...
def sgd(
    ...
    *,
    ...
    dense_params = params
    dense_d_p_list = d_p_list
    dense_momentum_buffer_list = momentum_buffer_list
    sparse_params = []
    has_sparse_grad = False
    if foreach and not torch.jit.is_scripting():
        ...
        for i, param in enumerate(params):
            if is_csr(param) or is_csr(d_p_list[i]):
                ...
                if param.is_sparse or d_p_list[i].is_sparse:
                    has_sparse_grad = True
    ...
    *,
    ...
    for (
        ...
        device_has_sparse_grad = has_sparse_grad and any(
            is_coo_or_csr(grad) for grad in device_grads
        )
